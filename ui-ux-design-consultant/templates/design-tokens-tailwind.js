 ...
 *
 * This is a complete token system template for Tailwind CSS projects.
 * Copy this to your tailwind.config.js and customize the values.
 *
 * Token Categories:
  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Accent color (for highlights, badges, special callouts)
        accent: {
          50: '#fefce8',
          100: '#fef9c3',
          200: '#fef08a',
        ...
        // Functional aliases (using CSS variables for dark mode support)
      ...
      // ============================================
      spacing: {
        // Standard scale is already good, add custom values if needed
        '18': '4.5rem',   // 72px
        '88': '22rem',    // 352px
        '128': '32rem',   // 512px
